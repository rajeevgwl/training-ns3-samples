...
NS_LOG_COMPONENT_DEFINE ("Ex3_CBR_Example");
...
main (int argc, char *argv[])
{
  ...
  pointToPoint.EnablePcapAll ("pm_ex3_cbr_traffic");
  phy.EnablePcap ("pm_ex3_cbr_traffic", apDevices.Get (0));
  csma.EnablePcap ("pm_ex3_cbr_traffic", csmaDevices.Get (0), true);
