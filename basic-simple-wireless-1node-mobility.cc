...
//
//
//./waf --run "scratch/basic-simple-wireless-1node-mobility"
//
//
...
std::string tracebase = "scratch/basic-simple-wireless-1node-mobility";
//std::string tracebase = "contrib/simple-wireless/examples";
